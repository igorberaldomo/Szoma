...
from utils.examples.create_pandas_table import create_pandas_table
from utils.editing.select_lines import select_lines

from utils.conection.production_connection import production_connection
engine = production_connection()


def select_complements(red, green, blue, palheta, tabela):
    lista_complementos = []
    if palheta == "triade":
        ...
        resultado1 = select_lines(resultado1)
        resultado2 = select_lines(resultado2)
