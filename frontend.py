...
def show_similar_colors():
    if len(st.session_state.resultados) >0:
        ...
        "</div>"
        "<div style='height: 200px; width: 500px; background-color: {}; padding: 0px; margin:90px 10px 0px 90px; display: flex; flex-direction: column;'>"
           "<div style='background-color: {} ; height: 90px; width: 440px; padding: 0px; margin: 10px 0px 0px 05px; display: flex; flex-direction: row; justify-content: space-around'>"
                "<div style='background-color: {} ; height: 80px; width: 140px; padding: 0px; margin: 05px 0px 0px 0px;'>"
