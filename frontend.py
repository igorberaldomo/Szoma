                    ...
                    script = (
                        "<div style='height: 300px; width: 700px; background-color: white; display:flex; flex-direction: row'>"
                            ...
                            "<div style='margin: 100px 0px 0px -80px;height: 100px; width: 150px; background-color: {}; '>"
                                "<p style='padding: 70px 0px 0px 10px; font-size: 12px; color: {};'>{}:{}</p>"
                            "</div>"
                            "<div style='height: 200px; width: 650px;; padding: 0px; margin:90px 10px 0px 90px; display: flex; flex-direction: column;'>"
                                "<div style='height: 90px; width: 440px; padding: 0px; margin: 10px 0px 0px 05px; display: flex; flex-direction: row; justify-content: space-around'>"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 05px 0px 0px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 5px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 05px 0px 0px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 05px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 05px 0px 0px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 05px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                "</div>"
                                "<div style='height: 90px; width: 440px; padding: 0px; margin: 10px 0px 0px 05px; display: flex; flex-direction: row;justify-content: space-around ;'  >"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 0px 0px 05px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 05px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 05px 0px 05px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 05px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                    "<div style='background-color: {} ; height: 80px; width: 180px; padding: 0px; margin: 05px 0px 5px 0px;'>"
                                        "<p style='padding: 55px 0px 0px 05px; font-size: 12px; color: {};'>{}:{}</p>"
                                    "</div>"
                                "</div>"   
                            "</div>"
