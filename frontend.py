                    ...
                    script = (
                        "<div style='height: 300px; width: 700px; background-color: white; position: relative;'>" 
                            ...
                            "<div style='height: 100px; width: 100px; background-color: {}; position: absolute; top: 120px; left: 50px;'>"
                                "<p style='position: absolute; top: 60px; left: 0px; font-size: 20px; color: {};'>{}:{}</p>"
                            "</div>"
                        "<div style='height: 200px; width: 300px; background-color: white; position: absolute; top: 50px; left: 350px;'>"
                            ...
                            "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px '>"
                                "<p style='position: absolute; top: 50px; left: 10px; font-size: 20px;color: {};'{}:{}</p>"
                        "</div>"
                        "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px'>"
                            "<p style='position: absolute; top: 50px; left: 110px; font-size: 20px;color: {};'>{}:{}</p>"
                        "</div>"
                        "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px'>"
                            "<p style='position: absolute; top: 50px; left: 210px; font-size: 20px;color: {};'>{}:{}</p>"
                        "</div>"
                    "</div>"
                    "<div style=' display: flex; flex-direction: row;'>"
                    "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px'>"
                        "<p style='position: absolute; top: 150px; left: 10px; font-size: 20px;color: {};'>{}:{}</p>"
                    "</div>"
                    "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px'>"
                        "<p style='position: absolute; top: 150px; left: 110px; font-size: 20px;color: {};'>{}:{}</p>"
                    "</div>"
                    "<div style='height: 80px; width: 80px; background-color: {}; margin: 10px'>"
                        "<p style='position: absolute; top: 150px; left: 210px; font-size: 20px;color: {};'>{}:{}</p>"
                    "</div>"
                    "</div>"
                    "</div>"
